...
class ThreadFCFS(ThreadScheduler):
...
class ThreadSJF(ThreadScheduler):
    def __init__(self,processes: list):
        super().__init__()
        self.PROCESSES = processes
...
class ThreadPriorityScheduler(ThreadScheduler):
    def __init__(self, processes: list):
        super().__init__()
        self.PROCESSES = processes
...
class ThreadRoundRobin(ThreadScheduler):
