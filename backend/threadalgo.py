...
fcfs_output=fcfs_scheduler.output()
print(fcfs_output)

print("SJF Scheduler")
sjf_scheduler = SJF(processes)
sjf_output=sjf_scheduler.output()
print(sjf_output)
...
priority_scheduler_output=priority_scheduler.output()
print(priority_scheduler_output)
